  ...
  Widget build(BuildContext context) {
    return
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(primary: Colors.blueGrey[300], minimumSize: Size(3000, altura), elevation: 2),
  ...
  Widget build(BuildContext context) {
    return
      ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(primary: Colors.white, minimumSize: const Size(3000, 70), elevation: 0),
        child: Text(texto, style: TextStyle(color: Colors.black87, fontSize: 20)),
      );
  }
}
